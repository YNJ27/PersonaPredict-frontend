...
// Use the deployed backend on Render, with fallback to local for development.
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || "https://personapredict-backend.onrender.com";
